...
import {BsPinMap, BsPeople, BsSoundwave} from 'react-icons/bs';
    ...
    return (
        <Offcanvas show={props.isOpen} onHide={props.isClose} style={{backgroundColor:"#f0f0f0"}}>
            ...
            <Offcanvas.Body>
                ...
                <Link to='records' className='nav-link active'><CDBSidebarMenuItem><BiLibrary/>Records</CDBSidebarMenuItem></Link>
                <Link to='verification' className='nav-link active'><CDBSidebarMenuItem><BsSoundwave/>Verification</CDBSidebarMenuItem></Link>
